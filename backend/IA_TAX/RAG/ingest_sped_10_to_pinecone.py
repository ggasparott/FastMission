...
def carregar_sped_csv(diretorio):
    caminho = os.path.join(diretorio, "tabela_4_3_10.csv")
    return pd.read_csv(caminho, encoding='utf-8-sig', header=0)

def processar_e_inserir_sped_10 ():
    ...
    if not diretorio or not os.path.isdir(diretorio):
        print("Nenhum diretório de mapeamento sped_10 encontrado.")
        return
